...
// Field-intelligence pipeline route groups, extracted into cohesive submodules
// (they access this module's shared helpers, e.g. `application_error`, as
// descendants). Re-exported so `routes::<handler>` continues to resolve for the
// router in server.rs.
mod alerts;
mod applications;
mod catalog;
...
pub use catalog::{
    get_catalog_product, list_catalog_products, register_catalog_product, CatalogProductsQuery,
};
pub use ingestion::{get_ingest_health, ingest_drone_session};
pub use alerts::{
    acknowledge_alert, evaluate_field_alerts, get_alert_lifecycle,
    get_alert_severity_classification, list_field_alerts, resolve_alert, AlertEvaluationRequest,
    AlertLifecycleActionRequest,
};
pub use applications::{
    create_application_run, get_application_run, list_field_findings, run_anomaly_app,
    run_crop_health_app, run_water_priority_app,
};
pub use proposals::{
    accept_proposal, create_proposal, get_proposal, list_field_proposals, reject_proposal,
};
