...
- **Next (batch 9 candidates, in order):** (c) CHIRPS ingestion + SPI; (d) phenology metrics + rule-based crop/tree/water classification; (e) Sen2Cor containerized L1C->L2A path; (f) Phase 4 (crop-type ML, Sentinel-1 water, dNBR forest loss, HLS).
