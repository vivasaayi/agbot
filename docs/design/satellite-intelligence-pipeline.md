...
- **Next (batch 10 candidates, in order):** (c2) SPI accumulation windows (SPI-3/6/12) + CHIRPS dekads + HTTPS fetcher;  (d) phenology metrics + rule-based crop/tree/water classification; (e) Sen2Cor containerized L1C->L2A path; (f) Phase 4 (crop-type ML, Sentinel-1 water, dNBR forest loss, HLS).
