...
use crate::ui::{AppState, UITheme, UIOverlayState};
            ...
            ui.horizontal(|ui| {
                ...
                ui.with_layout(egui::Layout::right_to_left(egui::Align::Center), |ui| {
                    ...
                    if ui.button("🏠 RTH").clicked() {
                        ...
                        overlay_state.add_notification("Return to Home initiated".to_string());
                    }
                    
                    if ui.button("🚨 Emergency").clicked() {
                        hud_state.flight_mode = FlightMode::Emergency;
                        hud_state.mission_status = MissionStatus::Aborted;
                        overlay_state.add_notification("EMERGENCY STOP ACTIVATED".to_string());
                    }
                });
            });
        });
                                    ...
                                    ui.horizontal(|ui| {
                                        ...
                                        ui.with_layout(egui::Layout::right_to_left(egui::Align::Center), |ui| {
                                            if !completed && ui.small_button("Skip").clicked() {
                                                overlay_state.add_notification(format!("Skipped waypoint {}", i));
                                            }
                                        });
                                    });
                                    ui.separator();
                    ...
                    ui.group(|ui| {
                        ...
                        ui.horizontal(|ui| {
                            if ui.button("▶️ Start").clicked() {
                                ...
                                overlay_state.add_notification("Mission started".to_string());
                            }
                            ...
                            if ui.button("⏹️ Stop").clicked() {
                                hud_state.mission_status = MissionStatus::Aborted;
                                overlay_state.add_notification("Mission aborted".to_string());
                            }
                        });
                    });
                });
