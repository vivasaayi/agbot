...
fn setup_main_menu(mut commands: Commands) {
    ...
    commands.spawn((MainMenuEntity, Name::new("MainMenuBackground")));
}

fn cleanup_main_menu(mut commands: Commands, menu_entities: Query<Entity, With<MainMenuEntity>>) {
    ...
    egui::CentralPanel::default()
        ...
        .show(ctx, |ui| {
            ui.vertical_centered(|ui| {
                ...
                // Clean, modern title
                ui.heading(
                    egui::RichText::new("AgBot Visualizer")
                        .size(56.0)
                ...
                ui.add_space(20.0);
                ui.label(
                    egui::RichText::new("Advanced Agricultural World Simulation Platform")
                        .size(18.0)
                ...
                ui.vertical_centered(|ui| {
                    ui.label(
                        egui::RichText::new("Version 2.0.0 | Sprint 2 Development")
                            .size(12.0)
