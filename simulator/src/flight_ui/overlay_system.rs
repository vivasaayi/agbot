...
use crate::flight_ui::{AppState, UIOverlayState};
            ...
            .show(ctx, |ui| {
                ui.horizontal(|ui| {
                    ...
                    let (icon, color) = match notification.level {
                        crate::flight_ui::NotificationLevel::Info => ("ℹ️", egui::Color32::LIGHT_BLUE),
                        crate::flight_ui::NotificationLevel::Success => ("✅", egui::Color32::GREEN),
                        crate::flight_ui::NotificationLevel::Warning => ("⚠️", egui::Color32::YELLOW),
                        crate::flight_ui::NotificationLevel::Error => ("❌", egui::Color32::RED),
                    };
