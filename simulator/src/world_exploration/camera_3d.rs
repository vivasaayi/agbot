...
impl Plugin for Camera3DPlugin {
    fn build(&self, app: &mut App) {
        app.init_resource::<Camera3DState>()
            .add_systems(Update, (camera_3d_controls, smooth_camera_transitions));
    }
}
        ...
        if let Some(target_pos) = camera_state.target_position {
            ...
            if distance > 0.01 {
                camera_transform.translation = camera_transform
                    .translation
                    .lerp(target_pos, transition_factor);
...
pub fn setup_globe_camera(commands: &mut Commands) -> Entity {
