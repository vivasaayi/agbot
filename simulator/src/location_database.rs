...
impl LocationDatabase {
    ...
    fn populate_default_locations(&mut self) {
        ...
        let locations = vec![
            ...
            Location {
                name: "Mexico City, Mexico".to_string(),
                lat: 19.4326,
                lon: -99.1332,
                zoom_level: 8.0,
            },
            ...
            Location {
                name: "Cairo, Egypt".to_string(),
                lat: 30.0444,
                lon: 31.2357,
                zoom_level: 8.0,
            },
            Location {
                name: "Cape Town, South Africa".to_string(),
                lat: -33.9249,
                lon: 18.4241,
                zoom_level: 8.0,
            },
            ...
            Location {
                name: "Melbourne, Australia".to_string(),
                lat: -37.8136,
                lon: 144.9631,
                zoom_level: 8.0,
            },
            Location {
                name: "Auckland, New Zealand".to_string(),
                lat: -36.8485,
                lon: 174.7633,
                zoom_level: 8.0,
            },
            // South America
            Location {
                name: "São Paulo, Brazil".to_string(),
                lat: -23.5505,
                lon: -46.6333,
                zoom_level: 8.0,
            },
            Location {
                name: "Rio de Janeiro, Brazil".to_string(),
                lat: -22.9068,
                lon: -43.1729,
                zoom_level: 8.0,
            },
            Location {
                name: "Buenos Aires, Argentina".to_string(),
                lat: -34.6118,
                lon: -58.3960,
                zoom_level: 8.0,
            },
            ...
            Location {
                name: "Grand Canyon, USA".to_string(),
                lat: 36.1069,
                lon: -112.1129,
                zoom_level: 10.0,
            },
            ...
            Location {
                name: "Eiffel Tower, Paris".to_string(),
                lat: 48.8584,
                lon: 2.2945,
                zoom_level: 15.0,
            },
            Location {
                name: "Statue of Liberty, New York".to_string(),
                lat: 40.6892,
                lon: -74.0445,
                zoom_level: 15.0,
            },
